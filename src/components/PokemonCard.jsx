    ...
    <div className="group relative bg-gradient-to-br from-white via-blue-50 to-purple-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-5 border-2 border-blue-200 hover:border-purple-400 flex flex-col items-center overflow-hidden hover:scale-105">
      ...
      <div className="flex w-full gap-2 mt-auto">
        ...
        <button
          type="button"
          onClick={onAdd}
          className={`flex-1 px-2 py-2.5 rounded-lg text-xs font-bold transition-all active:scale-95 flex justify-center items-center gap-1.5 ${inTeam ? 'bg-red-600 hover:bg-red-700 text-white shadow-md hover:shadow-red-500/40' : 'bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white shadow-md hover:shadow-emerald-500/50'}`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4">
...
export default function PokemonCard({
  ...
  return (
    <div className="group relative bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 p-5 border border-slate-100 flex flex-col items-center overflow-hidden">
      ...
      {/* Círculo decorativo de fondo e Imagen */}
      <div className="relative w-full flex justify-center mt-2 mb-4">
        <div className="absolute inset-0 bg-slate-50 rounded-full scale-75 group-hover:bg-blue-50 transition-colors duration-300"></div>
        <img
          src={imageUrl}
          alt={name}
          className="relative w-32 h-32 object-contain drop-shadow-md group-hover:scale-110 transition-transform duration-300"
      ...
      <div className="flex w-full gap-2 mt-auto">
        ...
        <button
          type="button"
          onClick={onAdd}
          className="flex-1 bg-emerald-500 hover:bg-emerald-600 text-white px-2 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-sm hover:shadow-emerald-500/40 active:scale-95 flex justify-center items-center gap-1"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
          </svg>
